...
$.extend($.validator, {
	...
	messages: {
		...
		digits: "Por favor coloque somente dígitos.",
		creditcard: "Por favor entre com um número válido de cartão de crédito.",
		equalTo: "Por favor entre com o mesmo valor de novo.",
